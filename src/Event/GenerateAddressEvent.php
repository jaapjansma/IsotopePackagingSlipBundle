...
class GenerateAddressEvent {
  ...
  public function __construct(IsotopePackagingSlipModel $packagingSlipModel, string $strAddress) {
   ...
   * @return string
   */
  public function getGeneratedAddress() {
   ...
   * @return $this
   */
  public function setGeneratedAddress(string $strAddress) {
    $this->strAddress = $strAddress;
    return $this;
  }
