...
(
  ...
  (
    ...
    (
      ...
      (
        'href'                => 'act=delete',
        'icon'                => 'delete.svg',
        'attributes'          => 'onclick="if(!confirm(\'' . $GLOBALS['TL_LANG']['tl_isotope_packaging_slip_shipper']['deleteConfirm'] . '\'))return false;Backend.getScrollOffset()"',
      ),
    )
  ),
  ...
  (
    ...
    'handle_only_paid' => array(
      'inputType' => 'checkbox',
      'eval' => ['tl_class' => 'w50 clr'],
      'sql' => ['type' => 'string', 'length' => 1, 'fixed' => true, 'default' => '']
    ),
    'isotope_packaging_slip_scheduled_picking_date' => array(
      'filter'                  => true,
      'inputType'               => 'text',
      'flag'                    => 8,
    ...
    'isotope_packaging_slip_scheduled_shipping_date' => array (
      'filter'                  => true,
      'inputType'               => 'text',
      'flag'                    => 8,
      'eval'                    => array('mandatory'=>false, 'rgxp'=>'date', 'datepicker'=>true, 'tl_class'=>'w50 wizard'),
